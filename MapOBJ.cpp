...
double MapOBJ::getLength()
{
	cout << "\nyou somehow called a empty funcion in MapOBJ\n";
	return -1;
}
double MapOBJ::getWidth()
{
	cout << "\nyou somehow called a empty funcion in MapOBJ\n";
	return -1;
}
...
//Setters
void MapOBJ::setX(double inputX)
{
	xPos = inputX;
}
void MapOBJ::setY(double inputY)
{
	yPos = inputY;
}
...
void MapOBJ::setLength(double inputLength)
{
	cout << "\nyou somehow called a empty funcion in MapOBJ\n";
}
void MapOBJ::setWidth(double inputWidth)
{
	cout << "\nyou somehow called a empty funcion in MapOBJ\n";
}
