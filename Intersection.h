...
public:
	...
	virtual LIGHTCOLOR checkLight(CARDINAL inputDirection, int laneNumber);	//we will asume that stop signs are the same as a red light
	virtual int *turnChoice(int xLoc, int yLoc);
	virtual int getNumberOfLanes(CARDINAL inputDirection);
};
